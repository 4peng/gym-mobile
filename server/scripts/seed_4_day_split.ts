...
const seedPrograms: SeedProgram[] = [
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        defaultSets: 3,
        restSeconds: 60,
        notes: "Clean push day. No heavy pulling = better recovery.",
        weightUnit: "kg",
        initialWeight: null,
  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        name: "Close Grip Cable Row (lighter)",
        defaultSets: 3,
        restSeconds: 75,
        notes: "This is your bouldering support day.",
        weightUnit: "kg",
        initialWeight: null,
        muscles: ["back", "arms"],
      },
      ...
      },
      {
        ...
        weightUnit: "kg",
        initialWeight: null,
        muscles: ["mobility", "back", "shoulder"],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        defaultSets: 3,
        restSeconds: 60,
        notes: "Controlled, not exhausting -> keeps CNS fresh.",
        weightUnit: "kg",
        initialWeight: null,
        muscles: ["core"],
      },
    ...
    exercises: [
      {
        ...
        defaultSets: 3,
        restSeconds: 180,
        notes: "This is your intensity day.",
        weightUnit: "kg",
        initialWeight: null,
      ...
      {
        id: "light-leg-raises",
        name: "Light leg raises (optional)",
        defaultSets: 2,
        restSeconds: 45,
        notes: "",
        weightUnit: "kg",
